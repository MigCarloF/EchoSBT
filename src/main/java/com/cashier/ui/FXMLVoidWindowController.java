...
public class FXMLVoidWindowController {
    ...
    void voidWindowSendRequestPressed(ActionEvent event) throws IOException {
        FXMLLoader anotherLoader = new FXMLLoader(getClass().getResource("../../../../resources/FXMLVoidRequestWindow.fxml"));
    ...
    void voidWindowVoidPressed(ActionEvent event) throws IOException {
        Parent tableViewParent = FXMLLoader.load(getClass().getResource("../../../../resources/FXMLVoidWindow.fxml"));
        Scene tableViewScene = new Scene(tableViewParent);
